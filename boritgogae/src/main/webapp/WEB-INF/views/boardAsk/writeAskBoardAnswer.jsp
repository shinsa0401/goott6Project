...
<body>
	...
	<div class="container">
		...
		<form action="/board/ask/answerCreate" method="post">
			<div class="mb-3 mt-3">
				<textarea class="form-control" id="ref" name="ref"
					...
					<div class="col-4">
						<div class="form-check">
							<input type="checkbox" class="form-check-input" id="isSecret"
								name="isSecret" value="Y"> <label
								class="form-check-label">비밀글</label>
						</div>
						<div class="form-check">
							<input type="checkbox" class="form-check-input" id="answerStatus"
								name="answerStatus" value="A"> <input type="hidden"
								class="form-check-input" id="answerStatus_hidden"
								name="answerStatus" value="-"> <label
								class="form-check-label">답변완료 설정</label>
						</div>
					</div>
				</div>
			</div>
