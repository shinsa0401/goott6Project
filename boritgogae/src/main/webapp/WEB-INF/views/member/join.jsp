...
<script type="text/javascript">
	...
	function doSignUp() {
		...
		let memberPwCf = document.getElementById("memberPwCf");
		...
		let reg = /^[0-9]+/g; //숫자만 입력하는 정규식
		  ...
		  if (!reg.test(phoneNumber.value)) {
			...
			if(!exptext.test(memberEmail.value)){
		...
		if (memberPwd.value == "") {
		 ...
		 let pwdCheck = /^(?=.*[a-zA-Z])(?=.*[!@#$%^*+=-])(?=.*[0-9]).{8,16}$/;
		  ...
		  if (memberPwd.value !== memberPwCf.value) {
	...
	<div class="container">
		<div class="input-form-backgroud row">
			<div class="input-form col-md-12 mx-auto">
				...
				<form name="join_form" action="/member/joinOk" method="post">
					<div class="row">
						<div class="col-md-6 mb-3">
							<label for="memberId">아이디</label> <input type="text"
								class="form-control" id="memberId" name="memberId"
							
								placeholder="6자이상 12자 이하" required>
						...
						<div class="col-md-6 mb-3">
							...
							name="phoneNumber"  id="phoneNumber"
								placeholder="ex -없이 숫자만 입력" required>
							<div class="invalid-feedback">아이디를 입력해주세요</div>
						</div>
					...
					<div class="row">
						<div class="col-md-6 mb-3">
							<label for="memberPwd">비밀번호</label> <input type="password"
								...
								placeholder="12자이상 24자이하" required>
							<div class="invalid-feedback">비밀번호를 입력해주세요.</div>
						</div>

						<div class="col-md-6 mb-3">
							<label for="memberPwCf">비밀번호 확인</label> <input type="password"
								class="form-control" id="memberPwCf" placeholder="12자이상 24자이하"
								required>
							<div class="invalid-feedback">비밀번호를 입력해주세요.</div>
						</div>
					</div>
...
2) 시행일자 : 2018년 05월 01일 
			...
			<div class="mb-4" style="text-align: center;">
				<button class="site-btn" type="button" onclick="doSignUp();">
					가입완료</button>
			</div>
			</form>
		</div>
