...
<script type="text/javascript">
	...
	$(function() {
		...
		$("select[id=majorClassSel]")
				.change(
						function() {
							...
							$("#subClassSel")
									.html(
											'<option value="--"> 중분류 옵션을 선택해 주세요</option>');
		...
		function uploadFile(file, editor) {
			prodNo = (majorClass + middleClass + subClass + brand + randNo
					+ weight + mainIngredient + size + color + etc);
			console.log(prodNo);
			data = new FormData();
			if (prodNo != "") {
	...
	function register(form) {
		...
		console.log(prodNo + ", " + prodName + ", " + prodQuantity + ", "
				+ prodPrice + ", " + prodImg + ", " + prodBrandName + ", "
				+ prodContent);
