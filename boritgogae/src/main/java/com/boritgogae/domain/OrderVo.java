...
public class OrderVo {
	...
	public OrderVo(int orderNo, String memberId, int prodTotalPrice, String deliveryOption, int totalPrice,
	...
	public String toString() {
		return "OrderVo [orderNo=" + orderNo + ", memberId=" + memberId + ", prodTotalPrice=" + prodTotalPrice
