...
public class OrderDetailDTO {
	...
	public OrderDetailDTO(int orderDetailNo, int orderNo, String prodNo, int qty, int prodSubTotalPrice,
			String cancelStatus, String returnOrExchange, int initialOrderDetailNo, String purchaseConfirm,
			String returnOrExchangeConfirm, String reviewStatus, String memberId, String deliveryStatus,
			String originalFile) {
		super();
	...
	public String toString() {
		return "OrderDetailDTO [orderDetailNo=" + orderDetailNo + ", orderNo=" + orderNo + ", prodNo=" + prodNo
				...
				+ ", reviewStatus=" + reviewStatus + ", memberId=" + memberId + ", deliveryStatus=" + deliveryStatus
