...
import com.boritgogae.board.question.persistence.ReplyQuestionDAO;

@Service
public class ReplyQuestionServiceImpl implements ReplyQuestionService {

	@Inject
	private ReplyQuestionDAO dao;
	
	@Inject BoardQuestionDAO bdao;
	
	// 댓글 등록
	@Override
	public boolean addReply(ReplyQuestionVo reply) throws Exception {
	...
	// 모든 댓글 얻어오기
	@Override
	public List<ReplyQuestionVo> getAllReply(int bno) throws Exception {
	...
	// 댓글 수정
	@Override
	public boolean modifyReply(ReplyQuestionVo reply) throws Exception {
		boolean result = false;
	...
	// 댓글 삭제
	@Override
	public boolean removeReply(ReplyQuestionVo reply) throws Exception {
		boolean result = false;
	...
	// 댓글의 댓글
	@Override
	public boolean reReply(ReplyQuestionVo reply) throws Exception {
		boolean result = false;
		// rno로 부모댓글 정보 얻어오기
		ReplyQuestionVo parentReply = dao.getParentReply(reply.getRno());
