...
public class UploadFileQuestion {
	...
	public UploadFileQuestion() {
		super();
	}

	public UploadFileQuestion(String savedOriginImageFileName, String thumbnailFileName, String notImageFileName,
			boolean isImage) {
		super();
