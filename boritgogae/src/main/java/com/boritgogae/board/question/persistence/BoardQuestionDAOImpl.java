...
import com.boritgogae.board.question.domain.ReadCountQuestionVo;
...
public class BoardQuestionDAOImpl implements BoardQuestionDAO {
	...
	// 게시판 전체목록 보기 
	@Override
	public List<BoardQuestionVo> selectAllBoard(PagingInfoQuestion pi) throws Exception {
	...
	// 게시판 글 작성하기
	@Override
	public int insertBoard(BoardQuestionVo board) throws Exception {
	...
	// 글 번호로 게시글 얻어오기
	@Override
	public BoardQuestionVo getBoard(int no) throws Exception {
	...
	// 글 번호로 첨부파일 얻어오기
	@Override
	public List<UploadFileQuestionVo> getAttachFiles(int no) throws Exception {
	...
	// 게시글 수정
	@Override
	public int updateBoard(BoardQuestionVo board) throws Exception {
	...
	// 게시글 조회시간 검색하기
	@Override
	public ReadCountQuestionVo getLastReadDate(Map<String, Object> readCount) throws Exception {
	...
	// 검색된 글의 개수 반환하는 메서드
	@Override
	public int getSearchResultCnt(SearchCriteriaQuestion sc) throws Exception {
	...
	@Override
	public List<BoardQuestionVo> getSearchResult(PagingInfoQuestion pi, SearchCriteriaQuestion sc) throws Exception {
