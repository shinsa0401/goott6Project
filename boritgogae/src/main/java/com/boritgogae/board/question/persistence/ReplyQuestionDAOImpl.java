...
@Repository
public class ReplyQuestionDAOImpl implements ReplyQuestionDAO{
	...
	// 댓글 등록
	@Override
	public int insertReply(ReplyQuestionVo reply) throws Exception {
	...
	@Override
	public List<ReplyQuestionVo> selectAllReply(int bno) {
	...
	// 댓글 수정
	@Override
	public int updateReply(ReplyQuestionVo reply) throws Exception {
	...
	// 댓글 삭제
	@Override
	public int deleteReply(ReplyQuestionVo reply) throws Exception {
	...
	// rno로 부모댓글의 정보 얻어오기
	@Override
	public ReplyQuestionVo getParentReply(int rno) throws Exception {
	...
	@Override
	public int updateRefOrder(ReplyQuestionVo parentReply) throws Exception {
