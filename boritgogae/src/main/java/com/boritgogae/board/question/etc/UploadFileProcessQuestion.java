...
public class UploadFileProcessQuestion {
	 ...
	 */
	public static UploadFileQuestion uploadFileProcess(String upPath, String originalFileName, byte[] file, String contentType) throws IOException {
		...
		UploadFileQuestion upFile = new UploadFileQuestion();
		...
		if (ImgMediaConfirmQuestion.getMediaType(contentType.toLowerCase()) != null) { // 이미지 파일이면..
