...
public class FreePageHandler {
    private FreeSearchCondition sc;
...
//    private String  keyword;
    ...
    public FreePageHandler(int totalCnt, Integer page) {
        this(totalCnt, new FreeSearchCondition(page, 10));
    }

    public FreePageHandler(int totalCnt, Integer page, Integer pageSize) {
        this(totalCnt, new FreeSearchCondition(page, pageSize));
    }

    public FreePageHandler(int totalCnt, FreeSearchCondition sc) {
    ...
    private void doPaging(int totalCnt, FreeSearchCondition sc) {
    ...
    public FreeSearchCondition getSc() {
        return sc;
    }

    public void setSc(FreeSearchCondition sc) {
        this.sc = sc;
    }
