...
import com.boritgogae.board.free.service.FreeReplyService;
...
public class FreeReplyController {
	...
	@ResponseBody
	public List<FreeReplyVo> list (int bno) throws Exception{
	...
	public String writer(@RequestBody FreeReplyVo rv,Integer bno, String replyer,HttpSession session) throws Exception{
...
//          return new ResponseEntity<>("WRT_OK", HttpStatus.OK);
	...
	// 댓글 수정
	 @RequestMapping(value = "/modify/{rno}")  
	    public ResponseEntity<String> modify(@PathVariable Integer rno, @RequestBody FreeReplyVo rv) throws Exception {
