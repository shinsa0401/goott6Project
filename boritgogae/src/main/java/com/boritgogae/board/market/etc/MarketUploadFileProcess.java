...
public class MarketUploadFileProcess {
	 ...
	 */
	public static MarketUploadFile uploadFileProcess(String upPath, String originalFileName, byte[] file, String contentType) throws IOException {
		...
		MarketUploadFile upFile = new MarketUploadFile();
		...
		if(MarketImgMediaConfirm.getMediaType(contentType.toLowerCase()) !=null){//이미지 파일이면....
