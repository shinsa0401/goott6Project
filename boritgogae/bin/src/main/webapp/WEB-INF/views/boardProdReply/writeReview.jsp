                ...
                <form action="/prodReply/addReview" method="post">
                    <div class="row">
                        <div class="col-lg-12 col-md-6">
                            ...
                            <div class="checkout__input">
                                <p>제목<span>*</span></p>
                                <input type="text" placeholder="제목을 입력하세요" class="checkout__input__add" id="title" name="title">
                            </div>
                            <div class="checkout__input Img">
                                <p>사진</p>
                                <div id="reviewImg" class="form-control" rows="5" style="height: 100px; resize:none;">사진을 드래그 드랍 해주세요</div>
                            </div>
                            <div class="checkout__input">
                                <p>내용<span>*</span></p>
                    ...
                    <div class="wrtieReview"><button type="submit" class="site-btn" onclick="return isValid();">리뷰 쓰기</button>
