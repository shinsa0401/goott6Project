...
function init(){
	...
	var confmKey = "devU01TX0FVVEgyMDIyMTAyMTE0NTQ0OTExMzEyMjY=";//승인키
...
<body onload="init();">
	<form id="form" name="form" method="post">
		<input type="hidden" id="confmKey" name="confmKey" value="devU01TX0FVVEgyMDIyMTAyMTE0NTQ0OTExMzEyMjY="/>
