...
public class BoardServiceImpl implements BoardService {
	...
	@Override
	public boolean write(BoardVO board, List<UploadFile> uploadFileLst) throws Exception {
	...
	@Override
	public Map<String, Object> getAllBoard(int pageNo, SearchCriteria sc) throws Exception { // 페이징하는중

		Paging pi = pagingPro(pageNo, sc);
	...
	// 페이징 구현
	private Paging pagingPro(int pageNo, SearchCriteria sc) throws Exception {
	...
	public Map<String, Object> viewContent(int no) throws Exception {
		...
		List<UploadFileVo> fileList = dao.getAttachFile(no);
