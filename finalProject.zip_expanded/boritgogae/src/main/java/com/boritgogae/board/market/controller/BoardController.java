...
import com.boritgogae.board.market.etc.UploadFileProcess;
...
public class BoardController {
	...
	public ModelAndView viewContent(@RequestParam("no") String no) throws Exception {
		...
		List<UploadFileVo> fileList = (List<UploadFileVo>)ListMap.get("fileList");
	...
	public ModelAndView getAllBoard( SearchCriteria sc, @RequestParam(value="pageNo", required=false, defaultValue = "1")int pageNo) throws Exception { 
		...
		Paging pi = (Paging)ListMap.get("paging");
